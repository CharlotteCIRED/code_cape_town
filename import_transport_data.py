...
for t_temp in np.arange(0, 30):
    print(t_temp)
    income_temp = import_transport_data(grid, param, t_temp, spline_inflation, spline_fuel)
...
def import_transport_data(grid, param, yearTraffic, spline_inflation, spline_fuel):
        ...
        #income centers
        income_centers_init = scipy.io.loadmat('C:/Users/Charlotte Liotta/Desktop/Cape Town - pour Charlotte/Modèle/projet_le_cap/0. Precalculated inputs/incomeCentersKeep.mat')['incomeCentersKeep']

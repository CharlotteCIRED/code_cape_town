...
options["WBUS2"] = 0
param["amenity_backyard"] = 0.70
param["amenity_settlement"] = 0.67
        

#NAME OF THE SIMULATION - TO EXPORT THE RESULTS

date = "171120"
name = date + options["coeff_land"] + str(options["WBUS2"]) + str(int(param["amenity_backyard"] * 100)) + str(int(param["amenity_settlement"] * 100))
